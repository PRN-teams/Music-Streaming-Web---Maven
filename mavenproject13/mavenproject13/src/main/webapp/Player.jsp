...
<script>
    ...
    const app = {
       ...
       <div class="song_row \${index == this.currentIndex ? 'song_active' : ''}" data-index="\${index}">
            <a href="like?songID=${requestScope.song.songID}"><i class="far fa-heart fa-2x" style="color: green ;padding:10px"></i></a>
            <div style:"padding-right: 10px">${song.likeCount}</div>
